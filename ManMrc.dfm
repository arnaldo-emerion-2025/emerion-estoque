inherited fmManMrc: TfmManMrc
  ...
  object pcMrc: TPageControl
      ...
      object Panel2: TPanel
        ...
        object Panel3: TPanel
          ...
          object grMrc: ThGrid
            ...
            Height = 197
            Selected.Strings = (
              'CODMRC'#9'10'#9'Código'
              'NOMMRC'#9'82'#9'Descrição')
    ...
    object pcPag2: TTabSheet
      ...
      object Panel4: TPanel
        ...
        object EdNomMrc: TdxDBColorEdit
          Left = 78
          Top = 45
          Width = 505
          Color = 16577773
  ...
  object EstMrc: TwwQuery
    Active = True
    CachedUpdates = True
    BeforeDelete = EstMrcBeforeDelete
    OnNewRecord = EstMrcNewRecord
    DatabaseName = 'ISade'
    SessionName = 'Default'
    SQL.Strings = (
      'Select * From EstMrc'
  ...
  object ppReport: TppReport
    ...
    Template.FileName = 'C:\_WGSYS\Emerion\Estoque\Relatorios\RManMrc.rtm'
    Units = utMillimeters
    UserName = 'Report'
    CachePages = True
    DeviceType = 'Screen'
