...
begin
  ...
  begin
    ...
    if Trim(EdPsqCodCat.Text) = '' then
      fmsgErro('Campo de Preenchimento Obrigatorio não Informado.', EdPsqCodCat);

    if EdPsqVcrIte.Value = 0 then
      fmsgErro('Campo de Preenchimento Obrigatorio não Informado.', EdPsqVcrIte);
