inherited fmManStr: TfmManStr
      ...
      object Panel5: TPanel
        ...
        object grUfe: ThGrid
          ...
          Selected.Strings = (
            ...
            'FLGNCALC_DIF_MVA'#9'1'#9'FLGNCALC_DIF_MVA'
            'REDSUB'#9'10'#9'REDSUB'
            'CODST2'#9'3'#9'CODST2'
            'CODCFO_DEV'#9'15'#9'CODCFO_DEV'
            'IVAENT'#9'10'#9'IVAENT'
            'REGTRIB'#9'10'#9'REGTRIB'
            'CODST1'#9'1'#9'CODST1'
            'ID_ESTUFE'#9'10'#9'ID_ESTUFE'
            'ICMSENT'#9'10'#9'ICMSENT'
            'GRUPO_ORIGEM'#9'40'#9'GRUPO_ORIGEM')
          IniAttributes.Delimiter = ';;'
          TitleColor = clBtnFace
          FixedCols = 0
          ShowHorzScrollBar = True
  ...
  object EstUfe: TwwQuery
    ...
    object EstUfeREGTRIB: TIntegerField
      DisplayWidth = 10
      FieldName = 'REGTRIB'
    end
  ...
  object UpEstUfe: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into EstUfe'
        ...
        'F, CODTME, '
      '   DTEENV, CODTCL, FLGNCALC_DIF_MVA, REDSUB, CODST2, REGTRIB)'
      'values'
