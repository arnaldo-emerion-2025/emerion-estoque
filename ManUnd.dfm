inherited fmManUnd: TfmManUnd
  ...
  object pcUnd: TPageControl
    ...
    object pcPag1: TTabSheet
      ...
      object Panel2: TPanel
        ...
        object EdPsqCodUnd: TdxColorEdit
          Left = 126
          Top = 21
          Width = 96
          Color = 16577773
        ...
        object Panel3: TPanel
          ...
          object grUnd: ThGrid
            ...
            TitleLines = 3
            TitleButtons = False
            OnDblClick = grUndDblClick
            IndicatorColor = icYellow
            CorDeFoco = clInfoBk
          end
        end
        object EdPsqNomUnd: TdxColorEdit
          Left = 126
          Top = 45
          Width = 238
          Color = 16577773
    ...
    object pcPag2: TTabSheet
      ...
      object Panel4: TPanel
        ...
        object EdNomUnd: TdxDBColorEdit
          Left = 126
          Top = 45
          Width = 455
          Color = 16577773
  ...
  object EstUnd: TwwQuery
    Active = True
    CachedUpdates = True
    BeforeDelete = EstUndBeforeDelete
    OnNewRecord = EstUndNewRecord
    DatabaseName = 'ISade'
    SessionName = 'Default'
    SQL.Strings = (
      'Select * From EstUnd'
    ...
    Left = 209
    Top = 252
    object EstUndCODUND: TStringField
      DisplayLabel = 'Código'
      DisplayWidth = 7
      FieldName = 'CODUND'
      Origin = 'ISADE.ESTUND.CODUND'
      FixedChar = True
      Size = 3
    end
    object EstUndNOMUND: TStringField
      DisplayLabel = 'Descrição'
      DisplayWidth = 85
      FieldName = 'NOMUND'
      Origin = 'ISADE.ESTUND.NOMUND'
      FixedChar = True
      Size = 40
    end
  end
  object DsUnd: TwwDataSource
    DataSet = EstUnd
    OnDataChange = DsUndDataChange
    Left = 237
    Top = 252
  end
  ...
  object ppReport: TppReport
    ...
    Template.FileName = 'C:\_WGSYS\Emerion\Pcp\Vmp\Relatorios\ManUnd.rtm'
    Units = utMillimeters
    UserName = 'Report'
    CachePages = True
    DeviceType = 'Screen'
