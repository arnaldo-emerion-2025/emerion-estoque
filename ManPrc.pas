     ...
     if fMsg('Atenção !' +#10+ 'Alterações Globais costumam ser MUITO DEMORADAS.' +#10+ 'Disso Depende a velocidade e a Memoria do seu Servidor, quanto maior for a Seleção de Itens, mais Tende a Demorar.' +#10+ 'Tem Certeza que Deseja Realizar esta Operação ?','S') then begin
        ...
        if CheckEdit06.Checked then begin
           ...
           if EdDs1Ite.Value > 0 then
              sUpdate := sUpdate + ' ,Ds1Ite = '''+ fConvertValor( EdDs1Ite.Text ) +''''
           else
        ...
        if CheckEdit07.Checked then begin
           ...
           if EdDs2Ite.Value > 0 then
              sUpdate := sUpdate + ' ,Ds2Ite = '''+ fConvertValor( EdDs2Ite.Text ) +''''
           else
        ...
        if CheckEdit08.Checked then begin
           ...
           if EdDs3Ite.Value > 0 then
              sUpdate := sUpdate + ' ,Ds3Ite = '''+ fConvertValor( EdDs3Ite.Text ) +''''
           else
        ...
        if CheckEdit09.Checked then begin
           ...
           if EdDs4Ite.Value > 0 then
              sUpdate := sUpdate + ' ,Ds4Ite = '''+ fConvertValor( EdDs4Ite.Text ) +''''
           else
        ...
        if CheckEdit10.Checked then begin
           ...
           if EdDs5Ite.Value > 0 then
              sUpdate := sUpdate + ' ,Ds5Ite = '''+ fConvertValor( EdDs5Ite.Text ) +''''
           else
        ...
        if CheckEdit11.Checked then begin
           ...
           if EdMs1Ite.Value > 0 then
              sUpdate := sUpdate + ' ,Ms1Ite = '''+ fConvertValor( EdMs1Ite.Text ) +''''
           else
        ...
        if CheckEdit12.Checked then begin
           ...
           if EdMs2Ite.Value > 0 then
              sUpdate := sUpdate + ' ,Ms2Ite = '''+ fConvertValor( EdMs2Ite.Text ) +''''
           else
        ...
        if CheckEdit13.Checked then begin
           ...
           if EdMs3Ite.Value > 0 then
              sUpdate := sUpdate + ' ,Ms3Ite = '''+ fConvertValor( EdMs3Ite.Text ) +''''
           else
        ...
        if CheckEdit14.Checked then begin
           ...
           if EdMs4Ite.Value > 0 then
              sUpdate := sUpdate + ' ,Ms4Ite = '''+ fConvertValor( EdMs4Ite.Text ) +''''
           else
        ...
        if CheckEdit15.Checked then begin
           ...
           if EdMs5Ite.Value > 0 then
              sUpdate := sUpdate + ' ,Ms5Ite = '''+ fConvertValor( EdMs5Ite.Text ) +''''
           else
        ...
        if CheckEdit16.Checked then begin
           ...
           if Trim( EdCodCm1.Text ) <> '' then
              sUpdate := sUpdate + ' ,CodCm1 = '''+ EdCodCm1.Text +''''
           else
        ...
        if CheckEdit17.Checked then begin
           ...
           if Trim( EdCodCm2.Text ) <> '' then
              sUpdate := sUpdate + ' ,CodCm2 = '''+ EdCodCm2.Text +''''
           else
        ...
        if CheckEdit18.Checked then begin
           ...
           if Trim( EdCodCm3.Text ) <> '' then
              sUpdate := sUpdate + ' ,CodCm3 = '''+ EdCodCm3.Text +''''
           else
        ...
        if CheckEdit19.Checked then begin
           ...
           if Trim( EdCodCm4.Text ) <> '' then
              sUpdate := sUpdate + ' ,CodCm4 = '''+ EdCodCm4.Text +''''
           else
        ...
        if CheckEdit20.Checked then begin
           ...
           if Trim( EdCodCm5.Text ) <> '' then
              sUpdate := sUpdate + ' ,CodCm5 = '''+ EdCodCm5.Text +''''
           else
        ...
        if Pos(',',sUpdate) > 0 then begin
           ...
           if Trim( EdPsqCodCat.Text ) <> '' then sFiltro := sFiltro + ' and EstPro.CodCat = '''+ EdPsqCodCat.Text +'''';
           if Trim( EdPsqCodTip.Text ) <> '' then sFiltro := sFiltro + ' and EstPro.CodTip = '''+ EdPsqCodTip.Text +'''';
           if Trim( EdPsqCodMrc.Text ) <> '' then sFiltro := sFiltro + ' and EstPro.CodMrc = '''+ EdPsqCodMrc.Text +'''';
           if Trim( EdPsqClsIpi.Text ) <> '' then sFiltro := sFiltro + ' and EstPro.ClfSai = '''+ EdPsqClsIpi.Text +'''';

           sFiltro := sFiltro + ')';

           if Trim( EdPsqCodEmp.Text ) <> '' then sFiltro := sFiltro + ' and EstIte.CodEmp = '''+ EdPsqCodEmp.Text +'''';
           if Trim( EdPsqCodClp.Text ) <> '' then sFiltro := sFiltro + ' and EstIte.CodClp = '''+ EdPsqCodClp.Text +'''';
           if Trim( EdPsqCodGru.Text ) <> '' then sFiltro := sFiltro + ' and EstIte.CodGru = '''+ EdPsqCodGru.Text +'''';
           if Trim( EdPsqCodSub.Text ) <> '' then sFiltro := sFiltro + ' and EstIte.CodSub = '''+ EdPsqCodSub.Text +'''';
           if Trim( EdPsqCodPro.Text ) <> '' then sFiltro := sFiltro + ' and EstIte.CodPro = '''+ EdPsqCodPro.Text +'''';
