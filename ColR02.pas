...
begin
  ...
  for i := 0 to fmEstR02.grR02.ColumnCount - 1 do begin

      Node := TLCustomize.Add;

      Node.Values[TLCustomizeColumn.Index] := fmEstR02.grR02.Columns[I].Caption;

      if fmEstR02.grR02.Columns[I].Visible then
         Node.Values[TLCustomizeIsVisible.Index] := TLCustomizeIsVisible.ValueChecked;

      Node.Data := fmEstR02.grR02.Columns[I];
