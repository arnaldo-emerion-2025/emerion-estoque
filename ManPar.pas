...
type
   TfmManPar = class(TfmPadrao)
      ...
      EstParQTDEAN: TIntegerField;
      EstParFLGTRG: TStringField;
      EstParBLOCST: TStringField;
      EstParATUVPF: TStringField;
      EstParATUFOR: TStringField;
      EstParFLGCOP: TStringField;
      EstParINDMSU: TStringField;
      EstParIGUALESTOQUE: TSmallintField;
      EstParATU_REGRAS_DBS: TStringField;
    EstParREPLICA_ITENS: TSmallintField;
    DBCheckBox1: TDBCheckBox;
    DBCheckBox2: TDBCheckBox;
    EstParMULTIPLAS_UF: TSmallintField;
    PaintBox: TPaintBox;
    EstParDECIMAIS_QTD: TStringField;
    EstParDECIMAIS_VALOR: TStringField;
    Label21: TLabel;
...
begin
   ...
   if EdFlgTam.Enabled then
      EdFlgTam.SetFocus
   else if EdTamCor.Enabled then
      EdTamCor.SetFocus
   else if EdFlgNeg.Enabled then
      EdFlgNeg.SetFocus;
...
begin
   ...
   if Trim(UpperCase(GLibAce)) = 'SIM' then begin
         ...
         if fMsg('Confirma Alterações', 'S') then begin
               if uppercase(EstParLANCBA.AsString) = 'SIM' then
