inherited fmManIcm: TfmManIcm
  Left = 398
  Top = 149
  Caption = 'Regras de ICMS para Operações de Entradas e Saídas'
  ClientHeight = 390
  ClientWidth = 625
  Color = 15788249
  OnClose = FormClose
  ...
  object EstIcm: TwwQuery
    Active = True
    CachedUpdates = True
    BeforeDelete = EstIcmBeforeDelete
  ...
  object ppReport: TppReport
    ...
    Template.FileName = 'C:\_WGSYS\Emerion\Estoque\Relatorios\RManIcm.rtm'
    Units = utMillimeters
    UserName = 'Report'
    CachePages = True
    DeviceType = 'Screen'
