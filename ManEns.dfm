inherited fmManEns: TfmManEns
  Tag = 4
  Left = 98
  Top = 206
  Caption = 'Entrada Simplificada de Mercadorias'
  ClientHeight = 391
  ClientWidth = 651
  OnClose = FormClose
  OnShow = FormShow
  ...
  object bPsqOpe: TSpeedButton
    Left = 198
    Top = 165
    Width = 23
    Height = 20
    Hint = 'Tipos de Operação de Entrada de Itens'
    Flat = True
    Glyph.Data = {
      36030000424D3603000000000000360000002800000010000000100000000100
      18000000000000030000C40E0000C40E00000000000000000000C0CFD0C0CFD0
  ...
  object EdCodOpe: TdxColorEdit
    Left = 111
    Top = 164
    Width = 86
    Hint = 'Codigo da Operação'
    Color = 16577773
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
