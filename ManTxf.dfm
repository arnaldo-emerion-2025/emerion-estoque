inherited fmManTxf: TfmManTxf
    ...
    object pcPag1: TTabSheet
      ...
      object Panel3: TPanel
        ...
        object grTxf: ThGrid
          ...
          Height = 173
          Selected.Strings = (
            'CODTXF'#9'20'#9'Código'
            'DSRTXF'#9'81'#9'Descrição Reduzida'#9'F')
  ...
  object EstTxf: TwwQuery
    CachedUpdates = True
    BeforeDelete = EstTxfBeforeDelete
    OnNewRecord = EstTxfNewRecord
    DatabaseName = 'ISade'
    SessionName = 'Default'
    SQL.Strings = (
      
        'select CODTXF, TIPTXF, DSRTXF, cast(DSCTXF as varchar(300)) DSCT' +
        'XF from EstTxf order by CodTxf')
    UpdateObject = upTxf
