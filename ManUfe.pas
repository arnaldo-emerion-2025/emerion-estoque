...
begin
  ...
  if nvPro.Salvar then begin
     ...
     if EdCodPro.Enabled then begin
        ...
        if Trim( GerProCodPro.Value ) <> '' then GerProCodPro.Value := FNumStrZero(GerProCodPro.Value);
...
procedure TfmManUfe.nvUfeSalva(Sender: TObject);
begin
  inherited;
...
procedure TfmManUfe.GerUfeBeforeDelete(DataSet: TDataSet);
begin
  inherited;
...
procedure TfmManUfe.nvIcmSalva(Sender: TObject);
begin
  inherited;
...
procedure TfmManUfe.GerIcmBeforeDelete(DataSet: TDataSet);
begin
  inherited;
...
procedure TfmManUfe.GerProBeforeDelete(DataSet: TDataSet);
begin
  inherited;
