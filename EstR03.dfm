inherited fmEstR03: TfmEstR03
  ...
  object grR03: TdxDBGrid
    ...
    ShowRowFooter = True
    OnReloadGroupList = grR03ReloadGroupList
    object DTEHIS: TdxDBGridDateColumn
      Width = 92
      BandIndex = 0
      RowIndex = 0
      FieldName = 'DTEHIS'
    end
    object ITEM: TdxDBGridMaskColumn
      Caption = 'Item'
      Width = 115
      BandIndex = 0
      RowIndex = 0
    ...
    object DSCPRO: TdxDBGridMaskColumn
      ...
      SummaryFooterFormat = 'Qtde de Itens ####0'
    end
    object OPERACAO: TdxDBGridMaskColumn
      Width = 141
      BandIndex = 0
      RowIndex = 0
      FieldName = 'OPERACAO'
    end
    object QTMOVI: TdxDBGridMaskColumn
      Caption = 'Quantidade'
      ...
      SummaryFooterFormat = 'Total ###,###,##0.0000'
    end
    object NUMENT: TdxDBGridColumn
    ...
    object ID_CMPPED: TdxDBGridColumn
      Alignment = taLeftJustify
  ...
  object DsR03: TwwDataSource
    DataSet = EstR03
    Left = 31
    Top = 345
  end
  object EstR03: TwwQuery
    Tag = 1
    CachedUpdates = True
    DatabaseName = 'ISade'
    Constrained = True
    SQL.Strings = (
      'Select EstHis.DteHis,'
      '           EstPro.DscPro,'
      '           EstHis.QtMovi,'
      '           EstHis.NroNfe,'
      ...
      '           EstPro.CodUns,'
        ...
        '           TextoOcor(EstHis.CodOpe,'#39'-'#39',EstOpe.NomOpe,'#39#39','#39#39','#39#39','#39#39 +
        ') as Operacao,'
      
        '           EstHis.CodClp || _UNICODE_FSS '#39'-'#39' || EstHis.CodGru ||' +
        ' _UNICODE_FSS '#39'.'#39' || EstHis.CodSub || _UNICODE_FSS '#39'.'#39' || EstHis' +
        '.CodPro as Item'
      'From EstHis LEFT JOIN EstPro ON (EstHis.CodClp = EstPro.CodClp'
        ...
        '                  LEFT JOIN EstOpe ON (EstHis.CodOpe = EstOpe.Co' +
        'dOpe)'
    ...
    object EstR03DTEHIS: TDateTimeField
      DisplayLabel = 'Emissão'
      FieldName = 'DTEHIS'
    end
    object EstR03CODUNS: TStringField
      DisplayLabel = 'Und'
      FieldName = 'CODUNS'
      FixedChar = True
      Size = 3
    end
    object EstR03OPERACAO: TStringField
      DisplayLabel = 'Operação'
      FieldName = 'OPERACAO'
      Size = 45
    end
    object EstR03QTMOVI: TFloatField
      DisplayLabel = 'Qtd Movimentada'
      FieldName = 'QTMOVI'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    object EstR03ITEM: TStringField
      FieldName = 'ITEM'
      Size = 18
    end
    object EstR03DSCPRO: TStringField
      FieldName = 'DSCPRO'
      FixedChar = True
      Size = 70
    end
    object EstR03NRONFE: TIntegerField
      FieldName = 'NRONFE'
    end
    object EstR03ID_CMPPED: TIntegerField
      FieldName = 'ID_CMPPED'
    end
    object EstR03NUMLOJ: TIntegerField
      FieldName = 'NUMLOJ'
    end
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Entradas'#13#10#13#10
      BandColor = clWhite
