...
type
   ...
   TfmEstR03 = class(TfmPadrao)
      ...
      ID_CMPPED: TdxDBGridColumn;
      NUMLOJ: TdxDBGridColumn;
      Colunas1: TMenuItem;
      EstR03ID_CMPPED: TIntegerField;
...
begin
   ...
   sBase := ' Select EstHis.DteHis,' +
      ...
      '             LEFT JOIN cmpen2 on (cmpen2.CodEmp = EstHis.CodEmp  ' +
      '                              and cmpen2.DteEnt = EstHis.DteEnt ' +
      '                              and cmpen2.NumEnt = EstHis.NumEnt ' +
      '                              and cmpen2.SeqEn2 = EstHis.SeqEn2) ' +
      '             LEFT JOIN CmpEnt ON (CmpEnt.CodEmp = CmpEn2.CodEmp ' +
      '                              and CmpEnt.DteEnt = CmpEn2.DteEnt ' +
      '                              and CmpEnt.NumEnt = CmpEn2.NumEnt) ';
...
begin
   ...
   if pos('Where', sFiltro) > 0 then
      sFiltro := sFiltro + ' and EstOpe.TipOpe = ' + QuotedStr('E')
   else
      sFiltro := ' Where EstOpe.TipOpe = ' + QuotedStr('E');
...
procedure TfmEstR03.Colunas1Click(Sender: TObject);
begin
   inherited;
   ...
   try
      ...
      fmManCol.Synchronize(fmEstR03.grR03);
