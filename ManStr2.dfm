inherited fmManStr2: TfmManStr2
    ...
    object pcPag2: TTabSheet
      ...
      object pEstUfe: TPanel
        ...
        object Label7: TLabel
          ...
          Width = 185
          Height = 13
          Hint = 'Indique aqui o Percentual para a Redução da base de Cálculo'
        ...
        object pnMVADestSN: TPanel
          ...
          ParentColor = True
          TabOrder = 24
          object lbMVADestSN: TLabel
            Left = 6
            Top = 9
            Width = 166
            Height = 13
            Hint = 
              'Informar a porcentagem reduzida do MVA para destinatário Simples' +
              ' Nacional'
            Caption = '% MVA para Destinatário SN :'
            Font.Charset = ANSI_CHARSET
            Font.Color = clBlack
            Font.Height = -11
            Font.Name = 'Tahoma'
          ...
          object Label33: TLabel
            ...
            Hint = 
              'Informar a porcentagem reduzida do MVA para destinatário Simples' +
              ' Nacional Produto'
            Caption = '% MVA para Destinatário SN  (SINIEF20) :'
            Font.Charset = ANSI_CHARSET
            Font.Color = clBlack
            Font.Height = -11
            Font.Name = 'Tahoma'
          ...
          object edMVADestSN: TdxDBColorCurrencyEdit
            Left = 243
            Top = 5
            Width = 68
            Hint = 
  ...
  object EstStr: TwwQuery
    ...
    object EstStrFLGATIVO: TSmallintField
      FieldName = 'FLGATIVO'
      Origin = 'ISADE.ESTSTR.FLGATIVO'
    end
  end
  ...
  object UpStr: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into EstStr'
      '  (CODSTR, TIPSTR,NOMSTR, IVAENT, NCM, ICMSENT, FLGATIVO)'
      'values'
      '  (:CODSTR, :TIPSTR,:NOMSTR, :IVAENT, :NCM, :ICMSENT, :FLGATIVO)')
    DeleteSQL.Strings = (
      'delete from EstStr'
  ...
  object UpEstUfe: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  MRGMVA_SN = :MRGMVA_SN,'
      '  MRGMVA_SN_SINIEF = :MRGMVA_SN_SINIEF'
      'where'
      '  CODSTR = :OLD_CODSTR and'
    ...
    InsertSQL.Strings = (
      'insert into EstUfe'
        ...
        '   MRGMVA, MRGMVA_SINIEF, UFEMITENTE, CODREGTRIB, MRGMVA_SN, MRG' +
        'MVA_SN_SINIEF)'
      'values'
        ...
        'EMITENTE, '
      '   :CODREGTRIB, :MRGMVA_SN, :MRGMVA_SN_SINIEF)')
    DeleteSQL.Strings = (
      'delete from EstUfe'
      'where'
      '  CODSTR = :OLD_CODSTR and'
  ...
  object EstUfe: TwwQuery
    ...
    object EstUfeMRGMVA_SN: TFloatField
      FieldName = 'MRGMVA_SN'
    end
    object EstUfeMRGMVA_SN_SINIEF: TFloatField
      FieldName = 'MRGMVA_SN_SINIEF'
    end
  end
end
