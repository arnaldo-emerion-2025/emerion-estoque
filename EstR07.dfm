inherited fmEstR07: TfmEstR07
  Left = 1
  Caption = 'Relação de Informações Fiscais dos Itens'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grR07: TdxDBGrid
    ...
    OptionsView = [edgoPreview, edgoUseBitmap]
    ...
    ShowRowFooter = True
    OnReloadGroupList = grR07ReloadGroupList
    object grR07NOMCAT: TdxDBGridMaskColumn
      Sorted = csUp
      Visible = False
      Width = 1712
      BandIndex = 0
    ...
    object grR07CODITE: TdxDBGridMaskColumn
    ...
    object grR07NOMGRU: TdxDBGridMaskColumn
      Sorted = csUp
      Visible = False
      Width = 1712
      BandIndex = 0
    ...
    object grR07NOMSUB: TdxDBGridMaskColumn
      Sorted = csUp
      Visible = False
      Width = 1712
      BandIndex = 0
    ...
    object grR07DSCPRO: TdxDBGridMaskColumn
      Caption = 'Descrição'
      Width = 321
      BandIndex = 0
      RowIndex = 0
    ...
    object grR07CLSIPI: TdxDBGridColumn
    ...
    object grR07PERIPI: TdxDBGridColumn
      Caption = '% IPI'
    ...
    object grR07PERICM: TdxDBGridColumn
      Caption = '% ICMS'
      HeaderAlignment = taRightJustify
      Width = 70
      BandIndex = 0
    ...
    object grR07CODSIT: TdxDBGridColumn
      Caption = 'C.S.T'
      Width = 67
      BandIndex = 0
      RowIndex = 0
    ...
    object grR07CBAPRO: TdxDBGridColumn
    ...
    object grR07CODANT: TdxDBGridColumn
      Caption = 'Cod. Antigo'
      Width = 129
      BandIndex = 0
      RowIndex = 0
  ...
  object EstR07: TwwQuery
    Tag = 1
    CachedUpdates = True
    DatabaseName = 'ISade'
    SQL.Strings = (
      
        'Select TextoOcor(IntStrZeros(EstPro.CodCat,3),'#39'-'#39',EstCat.NomCat,' +
        #39#39','#39#39','#39#39','#39#39') as NomCat,'
      
        '           TextoOcor(IntStrZeros(EstPro.CodMrc,3),'#39'-'#39',EstMrc.Nom' +
        'Mrc,'#39#39','#39#39','#39#39','#39#39') as NomMrc,'
        ...
        '           TextoOcor(EstIcm.CodSt1,EstIcm.CodSt2,'#39#39','#39#39','#39#39','#39#39','#39#39')' +
        ' as CodSit,'
      '           EstPro.DscPro,'
      '           EstIpi.PerIpi,'
      '           EstIcm.PerIcm,'
      ...
      '           EstPro.CodAnt,'
        ...
        '           EstPro.CodClp || _UNICODE_FSS '#39'-'#39' || EstPro.CodGru ||' +
        ' _UNICODE_FSS '#39'.'#39' || EstPro.CodSub || _UNICODE_FSS '#39'.'#39' || EstPro' +
        '.CodPro as CodIte'
      'From EstPro LEFT JOIN EstCat ON (EstPro.CodCat = EstCat.CodCat)'
        ...
        '                    LEFT JOIN EstIcm ON (EstPro.IcmSai = EstIcm.' +
        'CodIcm'
      
        '                                                AND  EstPro.IcmT' +
        'sd = EstIcm.TipIcm)'
      
        '                      LEFT JOIN EstIpi ON (EstPro.IpiSai = EstIp' +
        'i.CodIpi'
      
        '                                                AND  EstPro.IpiT' +
        'sd = EstIpi.TipIpi)'
      'Where EstPro.CodClp = :CodClp'
      'Order by EstPro.CodCat,EstPro.CodGru,EstPro.CodSub,EstPro.DscPro')
    ...
    object EstR07NOMCAT: TStringField
      DisplayLabel = 'Categoria'
      FieldName = 'NOMCAT'
      FixedChar = True
      Size = 100
    end
    object EstR07NOMMRC: TStringField
      DisplayLabel = 'Marca'
      FieldName = 'NOMMRC'
      FixedChar = True
      Size = 100
    end
    object EstR07NOMGRU: TStringField
      DisplayLabel = 'Grupo'
      FieldName = 'NOMGRU'
      FixedChar = True
      Size = 100
    end
    object EstR07NOMSUB: TStringField
      DisplayLabel = 'SubGrupo'
      FieldName = 'NOMSUB'
      FixedChar = True
      Size = 100
    end
    object EstR07DSCPRO: TStringField
      DisplayLabel = 'Descrição Completa'
      FieldName = 'DSCPRO'
      FixedChar = True
      Size = 70
    end
    object EstR07CODSIT: TStringField
      FieldName = 'CODSIT'
      FixedChar = True
      Size = 10
    end
    object EstR07PERIPI: TFloatField
      FieldName = 'PERIPI'
      DisplayFormat = '####0'
      Precision = 2
    end
    object EstR07PERICM: TFloatField
      FieldName = 'PERICM'
      DisplayFormat = '####0'
      Precision = 2
    end
    object EstR07CLSIPI: TStringField
      FieldName = 'CLSIPI'
      FixedChar = True
      Size = 30
    end
    object EstR07CBAPRO: TStringField
      FieldName = 'CBAPRO'
      FixedChar = True
    end
    object EstR07CODANT: TStringField
      FieldName = 'CODANT'
      FixedChar = True
      Size = 30
    end
    object EstR07CODITE: TStringField
      FieldName = 'CODITE'
      Size = 16
    end
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de Informações Fiscais dos Itens'
      BandColor = clWhite
