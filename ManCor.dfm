inherited fmManCor: TfmManCor
  ...
  object pcCor: TPageControl
    ...
    object pcPag1: TTabSheet
      ...
      object Panel2: TPanel
        ...
        object EdPsqCodCor: TdxColorEdit
          Left = 78
          Top = 24
          Width = 96
          Color = 16577773
        ...
        object Panel3: TPanel
          ...
          object grCor: ThGrid
            ...
            Height = 197
            Selected.Strings = (
              'CODCOR'#9'10'#9'Código'
              'NOMCOR'#9'82'#9'Descrição'#9'F')
            ...
            TitleLines = 3
            TitleButtons = False
            OnDblClick = grCorDblClick
            IndicatorColor = icYellow
            CorDeFoco = clInfoBk
          end
        end
        object EdPsqNomCor: TdxColorEdit
          Left = 78
          Top = 48
          Width = 286
          Color = 16577773
    ...
    object pcPag2: TTabSheet
      ...
      object Panel4: TPanel
        ...
        object EdNomCor: TdxDBColorEdit
          Left = 78
          Top = 48
          Width = 505
          Color = 16577773
  ...
  object EstCor: TwwQuery
    Active = True
    CachedUpdates = True
    BeforeDelete = EstCorBeforeDelete
    OnNewRecord = EstCorNewRecord
    DatabaseName = 'ISade'
    SessionName = 'Default'
    SQL.Strings = (
      'Select * From EstCor'
