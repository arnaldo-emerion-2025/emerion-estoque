inherited fmManTip: TfmManTip
  ...
  object pcTip: TPageControl
      ...
      object Panel2: TPanel
        ...
        object Panel3: TPanel
          ...
          object grTip: ThGrid
            ...
            Height = 197
            Selected.Strings = (
              'CODTIP'#9'10'#9'Código'
              'NOMTIP'#9'82'#9'Descrição'#9'F')
    ...
    object pcPag2: TTabSheet
      ...
      object Panel4: TPanel
        ...
        object EdNomTip: TdxDBColorEdit
          Left = 78
          Top = 48
          Width = 505
          Color = 16577773
  ...
  object EstTip: TwwQuery
    Active = True
    CachedUpdates = True
    BeforeDelete = EstTipBeforeDelete
    OnNewRecord = EstTipNewRecord
    DatabaseName = 'ISade'
    SessionName = 'Default'
    SQL.Strings = (
      'Select * From EstTip'
  ...
  object ppReport: TppReport
    ...
    Template.FileName = 'C:\_WGSYS\Emerion\Estoque\Relatorios\RManTpr.rtm'
    Units = utMillimeters
    UserName = 'Report'
    CachePages = True
    DeviceType = 'Screen'
