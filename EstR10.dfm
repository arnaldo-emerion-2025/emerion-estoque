inherited fmEstR10: TfmEstR10
  Left = 1
  Caption = 'Relação de Códigos de Barras'
  ClientHeight = 481
  ClientWidth = 787
  Position = poDesigned
  OnClose = FormClose
  ...
  object grR10: TdxDBGrid
    ...
    ShowRowFooter = True
    OnReloadGroupList = grR10ReloadGroupList
    object ITEM: TdxDBGridColumn
      Caption = 'Código'
      Width = 103
      BandIndex = 0
      RowIndex = 0
    ...
    object CODB01: TdxDBGridColumn
      Caption = 'Codigo Barras 1'
      Width = 111
      BandIndex = 0
      RowIndex = 0
      FieldName = 'CODB01'
    end
    object CUBB01: TdxDBGridColumn
      Caption = 'Cubagem 1'
    ...
    object CODB02: TdxDBGridColumn
      Caption = 'Codigo Barras 2'
      Width = 111
      BandIndex = 0
      RowIndex = 0
      FieldName = 'CODB02'
    end
    object CUBB02: TdxDBGridColumn
      Caption = 'Cubagem 2'
      HeaderAlignment = taRightJustify
      Width = 87
      BandIndex = 0
    ...
    object CODB03: TdxDBGridColumn
      Caption = 'Codigo Barras 3'
      Width = 111
      BandIndex = 0
      RowIndex = 0
      FieldName = 'CODB03'
    end
    object CUBB03: TdxDBGridColumn
      Caption = 'Cubagem 3'
      HeaderAlignment = taRightJustify
      Width = 87
      BandIndex = 0
    ...
    object CODB04: TdxDBGridColumn
      Caption = 'Codigo Barras 4'
      Width = 109
      BandIndex = 0
      RowIndex = 0
      FieldName = 'CODB04'
    end
    object CUBB04: TdxDBGridColumn
      Caption = 'Cubagem 4'
      HeaderAlignment = taRightJustify
      Width = 89
      BandIndex = 0
  ...
  object DsR10: TwwDataSource
    DataSet = EstR10
    Left = 31
    Top = 351
  end
  object EstR10: TwwQuery
    Tag = 1
    CachedUpdates = True
    DatabaseName = 'ISade'
    Constrained = True
    SQL.Strings = (
      ...
      '           EstPro.DscPro,'
        ...
        '           EstR10.CodClp || _UNICODE_FSS '#39'-'#39' || EstR10.CodGru ||' +
        ' _UNICODE_FSS '#39'.'#39' || EstR10.CodSub || _UNICODE_FSS '#39'.'#39' || EstR10' +
        '.CodPro as Item'
      'From EstR10 LEFT JOIN EstPro ON (EstR10.CodClp = EstPro.CodClp'
        ...
        '                                                  AND EstR10.Cod' +
        'Pro = EstPro.CodPro)'
      'Where EstR10.SeqArq = :SeqArq'
      'Order by EstR10.CodClp,EstR10.CodGru,EstR10.CodSub,EstR10.CodPro')
    ...
    object EstR10SEQARQ: TStringField
      FieldName = 'SEQARQ'
      FixedChar = True
      Size = 22
    end
    object EstR10CODCLP: TStringField
      FieldName = 'CODCLP'
      FixedChar = True
      Size = 1
    end
    object EstR10CODGRU: TStringField
      FieldName = 'CODGRU'
      FixedChar = True
      Size = 3
    end
    object EstR10CODSUB: TStringField
      FieldName = 'CODSUB'
      FixedChar = True
      Size = 4
    end
    object EstR10CODPRO: TStringField
      FieldName = 'CODPRO'
      FixedChar = True
      Size = 5
    end
    object EstR10CODB01: TStringField
      FieldName = 'CODB01'
      FixedChar = True
    end
    object EstR10CUBB01: TFloatField
      FieldName = 'CUBB01'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR10QTDB01: TFloatField
      FieldName = 'QTDB01'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR10CODB02: TStringField
      FieldName = 'CODB02'
      FixedChar = True
    end
    object EstR10CUBB02: TFloatField
      FieldName = 'CUBB02'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR10QTDB02: TFloatField
      FieldName = 'QTDB02'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR10CODB03: TStringField
      FieldName = 'CODB03'
      FixedChar = True
    end
    object EstR10CUBB03: TFloatField
      FieldName = 'CUBB03'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR10QTDB03: TFloatField
      FieldName = 'QTDB03'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR10CODB04: TStringField
      FieldName = 'CODB04'
      FixedChar = True
    end
    object EstR10CUBB04: TFloatField
      FieldName = 'CUBB04'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR10QTDB04: TFloatField
      FieldName = 'QTDB04'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR10DSCPRO: TStringField
      FieldName = 'DSCPRO'
      FixedChar = True
      Size = 70
    end
    object EstR10ITEM: TStringField
      FieldName = 'ITEM'
      Size = 16
    end
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de Códigos de Barras'#13#10#13#10
      BandColor = clWhite
