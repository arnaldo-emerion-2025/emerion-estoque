inherited fmEstR04: TfmEstR04
  ...
  object grR04: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          item
            ColumnName = 'grR04QTMOVI'
            SummaryFormat = 'Total ###,###,##0.0000'
            SummaryType = cstSum
          end>
    ...
    ShowRowFooter = True
    OnReloadGroupList = grR04ReloadGroupList
    object grR04DTEHIS: TdxDBGridDateColumn
      Width = 78
      BandIndex = 0
      RowIndex = 0
      FieldName = 'DTEHIS'
    end
    object grR04ITEM: TdxDBGridMaskColumn
      Caption = 'Item'
      Width = 57
      BandIndex = 0
      RowIndex = 0
    ...
    object grR04DSCPRO: TdxDBGridMaskColumn
      Caption = 'Descrição'
      Width = 162
      BandIndex = 0
      RowIndex = 0
    ...
    object grR04OPERACAO: TdxDBGridMaskColumn
      Width = 103
      BandIndex = 0
      RowIndex = 0
      FieldName = 'OPERACAO'
    end
    object grR04QTMOVI: TdxDBGridMaskColumn
      Caption = 'Quantidade'
    ...
    object grR04SEQSDF: TdxDBGridColumn
      Caption = 'Nro.'
      Width = 65
      BandIndex = 0
      RowIndex = 0
    ...
    object grR04OBSSDF: TdxDBGridColumn
      Caption = 'Obs. da saída'
      Width = 246
      BandIndex = 0
      RowIndex = 0
      FieldName = 'OBSSDF'
  ...
  object EstR03: TwwQuery
    ...
    SQL.Strings = (
      ...
      'EstPro.CodUns,'
        ...
        'TextoOcor(EstHis.CodOpe,'#39'-'#39',EstOpe.NomOpe,'#39#39','#39#39','#39#39','#39#39') as Operac' +
        'ao,'
      
        'EstHis.CodClp || _UNICODE_FSS '#39'-'#39'|| EstHis.CodGru || _UNICODE_FS' +
        'S '#39'.'#39'|| EstHis.CodSub || _UNICODE_FSS '#39'.'#39'|| EstHis.CodPro as Ite' +
        'm'
      'From EstHis'
      ...
      'LEFT JOIN GerEmp ON (EstHis.CodEmp = GerEmp.CodEmp)'
        ...
        'LEFT JOIN ESTSDF ON (ESTSDF.anosdf = EstHis.anosdf and EstSdf.se' +
        'qsdf = EstHis.seqsdf)'
    ...
    object EstR03SEQSDF: TIntegerField
      FieldName = 'SEQSDF'
    end
    object EstR03OBSSDF: TStringField
      FieldName = 'OBSSDF'
      Size = 100
    end
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Saidas'#13#10#13#10
      BandColor = clWhite
