inherited fmEstR08: TfmEstR08
  Left = 238
  Top = 115
  Caption = 'Ficha Fisica de Movimentações de Itens'
  ClientHeight = 481
  ClientWidth = 787
  Position = poDesigned
  OnClose = FormClose
  ...
  object grR08: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          item
            ColumnName = 'grR08QTDENT'
            SummaryFormat = '###,###,##0.0000'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR08QTDSDA'
            SummaryFormat = '###,###,##0.0000'
            SummaryType = cstSum
          end>
    ...
    ShowRowFooter = True
    OnReloadGroupList = grR08ReloadGroupList
    object grR08DTEHIS: TdxDBGridDateColumn
      Caption = 'Dia'
      Width = 93
      BandIndex = 0
      RowIndex = 0
    ...
    object grR08OPERACAO: TdxDBGridMaskColumn
    ...
    object grR08QTDENT: TdxDBGridMaskColumn
    ...
    object grR08QTDSDA: TdxDBGridMaskColumn
      Caption = 'Qtde Saída'
      HeaderAlignment = taRightJustify
      Width = 121
      BandIndex = 0
    ...
    object grR08SLDATU: TdxDBGridMaskColumn
      Caption = 'Saldo'
      HeaderAlignment = taRightJustify
      Width = 124
      BandIndex = 0
  ...
  object EstR08: TwwQuery
    ...
    object EstR08SEQARQ: TStringField
      FieldName = 'SEQARQ'
      FixedChar = True
      Size = 22
    end
    object EstR08DTEHIS: TDateTimeField
      FieldName = 'DTEHIS'
    end
    object EstR08SEQHIS: TIntegerField
      FieldName = 'SEQHIS'
    end
    object EstR08CODEMP: TIntegerField
      FieldName = 'CODEMP'
    end
    object EstR08CODCLP: TStringField
      FieldName = 'CODCLP'
      FixedChar = True
      Size = 1
    end
    object EstR08CODGRU: TStringField
      FieldName = 'CODGRU'
      FixedChar = True
      Size = 3
    end
    object EstR08CODSUB: TStringField
      FieldName = 'CODSUB'
      FixedChar = True
      Size = 4
    end
    object EstR08CODPRO: TStringField
      FieldName = 'CODPRO'
      FixedChar = True
      Size = 5
    end
    object EstR08CODOPE: TStringField
      FieldName = 'CODOPE'
      FixedChar = True
      Size = 2
    end
    object EstR08SLDANT: TFloatField
      Tag = 75
      FieldName = 'SLDANT'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR08QTDENT: TFloatField
      Tag = 75
      FieldName = 'QTDENT'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR08QTDSDA: TFloatField
      Tag = 75
      FieldName = 'QTDSDA'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR08SLDATU: TFloatField
      Tag = 75
      FieldName = 'SLDATU'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR08CSTPRO: TFloatField
      Tag = 75
      FieldName = 'CSTPRO'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR08VCHPRO: TFloatField
      Tag = 74
      FieldName = 'VCHPRO'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR08VREPRO: TFloatField
      Tag = 74
      FieldName = 'VREPRO'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR08VCPPRO: TFloatField
      Tag = 74
      FieldName = 'VCPPRO'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR08VPRPRO: TFloatField
      Tag = 74
      FieldName = 'VPRPRO'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR08VMEPRO: TFloatField
      Tag = 74
      FieldName = 'VMEPRO'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR08VPFPRO: TFloatField
      Tag = 74
      FieldName = 'VPFPRO'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR08OPERACAO: TStringField
      FieldName = 'OPERACAO'
      FixedChar = True
      Size = 100
    end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Ficha Fisica de Movimentações de Itens'#13#10
      BandColor = clWhite
  ...
  object PopUpMenu: TPopupMenu
    ...
    object Ordernacaopadrao: TMenuItem
      Caption = 'Ordernação padrão'
      OnClick = OrdernacaopadraoClick
    end
  end
