inherited fmEstR05: TfmEstR05
  Left = 369
  Top = 114
  Caption = 'Itens Abaixo do Estoque Minimo Estabelecido'
  ClientHeight = 491
  ClientWidth = 798
  OnClose = FormClose
  PixelsPerInch = 96
  ...
  object rgStatus: TRadioGroup
    ...
    Items.Strings = (
      ...
      'Abaixo do Minimo'
      'Abaixo do Maximo'
      'Entre o Minimo e Zero'
      'Entre o Minimo e o Maximo')
    ParentFont = False
    TabOrder = 18
  end
  object grR05: TdxDBGrid
    Left = 3
    Top = 255
    Width = 782
    Height = 226
    ...
    OptionsCustomize = [edgoBandPanelSizing, edgoBandSizing, edgoColumnMoving, edgoColumnSizing, edgoExtCustomizing, edgoFullSizing, edgoHeaderPanelSizing, edgoKeepColumnWidth, edgoNotHideColumn]
    OptionsDB = [edgoCanNavigation, edgoLoadAllRecords, edgoUseBookmarks]
    OptionsView = [edgoRowSelect, edgoUseBitmap]
    ...
    ShowRowFooter = True
    OnReloadGroupList = grR05ReloadGroupList
    object grR05Column8: TdxDBGridColumn
      Caption = 'Grupo'
      Width = 90
      BandIndex = 0
      RowIndex = 0
    ...
    object grR05Column9: TdxDBGridColumn
      Caption = 'Sub'
      Width = 90
      BandIndex = 0
      RowIndex = 0
    ...
    object grR05Column10: TdxDBGridColumn
      Caption = 'Item'
      Width = 90
      BandIndex = 0
      RowIndex = 0
    ...
    object grR05DSCPRO: TdxDBGridColumn
      Caption = 'Descrição'
      Sorted = csDown
      Width = 600
      BandIndex = 0
    ...
    object grR05Column11: TdxDBGridColumn
      Caption = 'Ref.Interna'
      Width = 200
      BandIndex = 0
      RowIndex = 0
    ...
    object grR05Column12: TdxDBGridColumn
      Caption = 'ID'
      Width = 150
      BandIndex = 0
      RowIndex = 0
    ...
    object grR05Column13: TdxDBGridColumn
      Caption = 'Marca'
      Width = 200
      BandIndex = 0
      RowIndex = 0
    ...
    object grR05QTMITE: TdxDBGridMaskColumn
    ...
    object grR05QMAITE: TdxDBGridColumn
      Caption = 'Máximo'
      HeaderAlignment = taRightJustify
      Width = 114
      BandIndex = 0
    ...
    object grR05QTRITE: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      Width = 130
      BandIndex = 0
      RowIndex = 0
    ...
    object grR05QTDITE: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      Width = 120
      BandIndex = 0
      RowIndex = 0
    ...
    object grR05Column14: TdxDBGridColumn
      Caption = 'Adquirido'
      HeaderAlignment = taRightJustify
      Width = 180
      BandIndex = 0
    ...
    object grR05Column15: TdxDBGridCurrencyColumn
      Caption = 'Ultimo Preço'
      Width = 180
      BandIndex = 0
      RowIndex = 0
      FieldName = 'VCRITE'
    ...
    object grR05SIMPRO: TdxDBGridColumn
      Caption = 'SIMILAR'
      Width = 175
      BandIndex = 0
      RowIndex = 0
    ...
    object grR05Column16: TdxDBGridColumn
      Caption = 'RMA'
      BandIndex = 0
      RowIndex = 0
      FieldName = 'QTDRMA'
    end
    object grR05Column17: TdxDBGridColumn
      Caption = 'Disponível'
      BandIndex = 0
      RowIndex = 0
      FieldName = 'QTSQTE'
  ...
  object EstR05: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           Estpro.refpro,'
      '           Estpro.idepro,'
      '           IntStrZeros(EstPro.CodMrc,3) as Marca,'
      '           EstPro.DscPro,'
      '           EstIte.QmaIte,'
      '           EstIte.QtmIte,'
      '           EstIte.QtrIte,'
      ...
      '           Round(EstIte.QtdIte - EstIte.QtrIte,4) as QtdIte,'
        ...
        '.CodPro as CodIte,'
      'round(Estite.VCRITE,4) as Vcrite'
      '  From EstIte'
      ''
      ...
      '  LEFT JOIN EstPro ON (EstIte.CodClp = EstPro.CodClp'
        ...
        '                                        AND  EstIte.CodGru = Est' +
        'Pro.CodGru '
      
        '                                        AND  EstIte.CodSub = Est' +
        'Pro.CodSub '
      
        '                                        AND  EstIte.CodPro = Est' +
        'Pro.CodPro)'
      
        '                        LEFT JOIN GerEmp ON (EstIte.CodEmp = Ger' +
        'Emp.CodEmp)'
      
        '                        LEFT JOIN EstMrc ON (EstPro.CodMrc = Est' +
        'Mrc.CodMrc)'
      
        'Order by EstIte.CodEmp,EstIte.CodClp,EstIte.CodGru,EstIte.CodSub' +
        ',EstIte.CodPro'
      ''
      ''
      ''
    ...
    Left = 288
    Top = 313
    object EstR05CODEMP: TIntegerField
      Alignment = taLeftJustify
      DisplayLabel = 'Empresa'
      FieldName = 'CODEMP'
    end
    object EstR05QTMITE: TFloatField
      DisplayLabel = 'Minimo'
      FieldName = 'QTMITE'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    object EstR05QTRITE: TFloatField
      DisplayLabel = 'Reservado'
      FieldName = 'QTRITE'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    object EstR05QTDITE: TFloatField
      DisplayLabel = 'Atual'
      FieldName = 'QTDITE'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    object EstR05DSCPRO: TStringField
      DisplayLabel = 'Descrição do Item'
      FieldName = 'DSCPRO'
      FixedChar = True
      Size = 70
    end
    object EstR05CODITE: TStringField
      FieldName = 'CODITE'
      Size = 16
    end
    object EstR05QMAITE: TFloatField
      FieldName = 'QMAITE'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR05CODCLP: TStringField
      FieldName = 'CODCLP'
      FixedChar = True
      Size = 1
    end
    object EstR05CODGRU: TStringField
      FieldName = 'CODGRU'
      FixedChar = True
      Size = 3
    end
    object EstR05CODSUB: TStringField
      FieldName = 'CODSUB'
      FixedChar = True
      Size = 4
    end
    object EstR05CODPRO: TStringField
      FieldName = 'CODPRO'
      FixedChar = True
      Size = 5
    end
    object EstR05REFPRO: TStringField
      FieldName = 'REFPRO'
    end
    object EstR05IDEPRO: TStringField
      FieldName = 'IDEPRO'
      Size = 30
    end
    object EstR05MARCA: TStringField
      FieldName = 'MARCA'
      FixedChar = True
      Size = 15
    end
    object EstR05QTAITE: TFloatField
      FieldName = 'QTAITE'
      DisplayFormat = '###,###,##0.0000'
    end
    object EstR05VCRITE: TFloatField
      FieldName = 'VCRITE'
      DisplayFormat = 'R$ #,##0.0000'
    end
    object EstR05SIMPRO: TStringField
      FieldName = 'SIMPRO'
      Size = 10
    end
    object EstR05QTDRMA: TFloatField
      FieldName = 'QTDRMA'
    end
    object EstR05QTSQTE: TFloatField
      FieldName = 'QTSQTE'
    end
  end
  object DsR05: TwwDataSource
    DataSet = EstR05
    Left = 316
    Top = 313
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      PrinterPage.Margins.Right = 11600
      PrinterPage.Margins.Top = 42900
      ...
      ReportTitle.Text = #13#10'Itens Abaixo do Estoque Minimo Estabelecido'#13#10#13#10
      BandColor = clWhite
      ...
      OddFont.Style = []
      Options = [tlpoHeaders, tlpoFlatCheckMarks]
